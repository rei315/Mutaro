...
public enum Resources {
    public enum Colors {
        ...
        public static let lightTurquoise = ColorAsset(name: "lightTurquoise")
        public static let navy = ColorAsset(name: "navy")
        public static let navy05 = ColorAsset(name: "navy05")
        public static let navy10 = ColorAsset(name: "navy10")
        public static let navy20 = ColorAsset(name: "navy20")
        public static let navy40 = ColorAsset(name: "navy40")
        public static let navy70 = ColorAsset(name: "navy70")
        public static let red = ColorAsset(name: "red")
        public static let turquoise = ColorAsset(name: "turquoise")
        public static let white = ColorAsset(name: "white")
        public static let wine = ColorAsset(name: "wine")
    }
...
public final class ColorAsset {
    ...
    public private(set) lazy var color: Color = .init(asset: self)
