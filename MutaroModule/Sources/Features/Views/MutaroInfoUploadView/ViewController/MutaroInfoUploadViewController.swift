...
final public class MutaroInfoUploadViewController: UIViewController {
    ...
    private func setupView() {
        ...
        imageView.lets {
            ...
            NSLayoutConstraint.activate([
                ...
                $0.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: imageHorizontalPadding),
                $0.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -imageHorizontalPadding),
        ...
        descriptionField.lets {
            ...
            NSLayoutConstraint.activate([
                ...
                descriptionLimitLabel.trailingAnchor.constraint(equalTo: $0.trailingAnchor, constant: -8),
                descriptionLimitLabel.bottomAnchor.constraint(equalTo: $0.bottomAnchor, constant: -4)
            ])
        }
    ...
    private func keyboardWillShow(notification: NSNotification) {
        ...
        guard let keyboardSize = (notification.userInfo?[UIResponder.keyboardFrameEndUserInfoKey] as? NSValue)?.cgRectValue,
              let keyboardDuration = (notification.userInfo?[UIResponder.keyboardAnimationDurationUserInfoKey] as? NSNumber)?.doubleValue else {
            return
        }
    ...
    private func keyboardWillHide(notification: NSNotification) {
        ...
        guard let keyboardDuration = (notification.userInfo?[UIResponder.keyboardAnimationDurationUserInfoKey] as? NSNumber)?.doubleValue else {
            return
        }
